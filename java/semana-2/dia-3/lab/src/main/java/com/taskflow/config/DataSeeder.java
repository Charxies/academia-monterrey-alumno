...
public class DataSeeder implements CommandLineRunner {
    ...
    // TODO (integrador, paso 5): verifica que los 3 proyectos y las 9 tareas sigan COHERENTES tras el
    //   CRUD de hoy (cada tarea apunta a un projectId que existe; hay >=1 tarea CON y >=1 SIN assignee
    //   para la matriz del 422). La semilla ya cumple esto: revísala, no la rehagas.
    @Override
