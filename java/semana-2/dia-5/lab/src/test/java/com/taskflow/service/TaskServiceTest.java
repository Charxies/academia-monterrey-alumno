 ...
 * reconstruyéndolo como unit puro con Mockito (mockeando TaskRepository, sin BD). NO se borra hoy: se
 * deja verde y anotado. // parche de S2D4: el unit test perdió su fake InMemory — S3D1 lo redime.
 *
