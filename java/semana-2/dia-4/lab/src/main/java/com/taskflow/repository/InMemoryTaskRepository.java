 ...
 */
// ================================================================================================
// TODO (S2D4, MP-6) — ESTA CLASE SE ELIMINA HOY. Cuando TaskRepository extienda JpaRepository, esta
// implementación en memoria deja de compilar (ya no implementa el mismo contrato) y SOBRA: la escribe
// Spring Data por debajo. Borrar código es SANO cuando la interfaz sobrevive — git lo recuerda.
// (No la borres antes de hacer el swap de la interfaz, o el proyecto no compilará a medio camino.)
// ================================================================================================
@Repository
